...
<body>
		...
		<p align="lleft"">
		<form action="promoteManager" method="POST">
			<table >
		 ...
		 <tr> <td align="left"> From Date </td> <td align="right">	<input type="text" id="from_date" name="to_date"/></td></tr>
		 <tr> <td align="left"> To Date </td> <td align="right"><input type="text" id="to_date" name="to_date"/> </td></tr>
